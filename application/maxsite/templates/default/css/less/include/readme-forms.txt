...
16. Класс p.hr можно использовать для визуальной отбивки ряда ячеек, например для кнопок.

17. Если необходимо обрамить все span-ячейки в строке, то используется label.fwrap, например:
